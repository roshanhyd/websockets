...
then
 ...
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='PROJECT_NAME';
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='SITE_NAME';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='PO_NAME';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='PSLC';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='PROJECT_STATUS';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='SITETRACKER';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
...
then
 -- Insert OLD values in audit table for logging purpose
 delete from SITE_PROJECTS_FIELD_CHANGES where SITE_PROJECTS_ID=:OLD.SITE_PROJECTS_ID and SITE_INFO_ID=:OLD.SITE_INFO_ID and FIELD_NAME='PO_STATUS';
  INSERT INTO SITE_PROJECTS_FIELD_CHANGES(SITE_PROJECTS_ID,SITE_INFO_ID,FIELD_NAME,FIELD_VALUE,SOURCE1,LAST_MODIFIED_BY,LAST_MODIFIED_DATE)
